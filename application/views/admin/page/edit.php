...
<table class="table">
	...
	<tr>
		<td>Template</td>
		<td><?php echo form_dropdown('template',array('page'=>'page','new_archive'=>'News archive','homepage'=>'Home Page'),$this->input->post('template') ? $this->input->post('template'): $page->template);?></td>
	</tr>
	<tr>
		<td>Title</td>
		<td><?php echo form_input('title',set_value('name',$page->title));?></td>
	</tr>
	<tr>
		<td>Slug</td>
